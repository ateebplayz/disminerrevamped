//DONT EDIT ANYTHING OK WITHOUT PERM
const Discord = require('discord.js')
const { prefix } = require('../config.json')
console.log('I hve accessed command base')
        ...
        for (const alias of commands) {
            ...
            if (
                ...
                if (cooldown > 0 && recentlyRan[cooldownString]) {
                    ...
                    .setColor('#FF0000')
                    .setDescription(`Slow Down Buddy! You gotta wait **${wait} seconds!** before using this command!`)
                    message.channel.send({embeds:[embedcd]})
                    return
                }
